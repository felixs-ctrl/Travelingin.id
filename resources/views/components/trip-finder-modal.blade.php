...
<div id="tripFinderModal" class="fixed inset-0 z-50 flex items-center justify-center hidden" style="font-family: 'Plus Jakarta Sans', sans-serif;">
    ...
    <div class="relative bg-[#0A192F] text-white w-full max-w-2xl mx-4 rounded-3xl border border-[#D4AF37]/30 shadow-2xl overflow-hidden transform scale-95 opacity-0 transition-all duration-300 z-10 p-8" id="tripFinderCard">
        <!-- Close Button -->
        <button onclick="closeTripFinderModal()" class="absolute top-5 right-5 w-9 h-9 flex items-center justify-center rounded-full bg-white/10 hover:bg-[#D4AF37] text-white hover:text-[#0A192F] transition-all duration-200 focus:outline-none z-20 shadow-md">
        ...
        <form id="tripFinderForm" onsubmit="event.preventDefault(); submitTripFinder();">
            ...
            <div class="wizard-step hidden" id="step-group">
                ...
                <div class="flex justify-between pt-2">
                    <button type="button" onclick="goToStep(1)" class="border-2 border-white/50 hover:border-white hover:bg-white/10 text-white/80 hover:text-white font-bold px-6 py-3 rounded-xl transition-all text-sm uppercase tracking-wider flex items-center gap-2">
            ...
            <div class="wizard-step hidden" id="step-focus">
                ...
                <div class="flex justify-between pt-2">
                    <button type="button" onclick="goToStep(2)" class="border-2 border-white/50 hover:border-white hover:bg-white/10 text-white/80 hover:text-white font-bold px-6 py-3 rounded-xl transition-all text-sm uppercase tracking-wider flex items-center gap-2">
                        <i class="fas fa-arrow-left text-xs"></i> Kembali
                    </button>
