...
<head>
    ...
    <title>Confirm Password | Travelingin.id</title>
    <!-- Fonts -->
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <div class="input-group">
                ...
                <div class="input-wrapper">
                    ...
                    <button type="button" onclick="togglePassword()" class="toggle-password-btn" title="Toggle password visibility">
            ...
            <button type="submit" class="btn-gold">
                {{ __('Confirm') }} <i class="fas fa-arrow-right"></i>
            </button>
        </form>
